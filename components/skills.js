const Skills = () => {
    ...
    return ( 
        <div className='lg:grid grid-cols-2 gap-2 col-span-1 row-span-1 mt-11'>
            ...
            {skills.map((skill) => (
                <div key={skill} className='rounded-md transition duration-700 ease-in-out hover:-transition align-middle p-4 lg:border-2 lg:border-yellow-400 hover:bg-yellow-400 focus:outline-none group'>
